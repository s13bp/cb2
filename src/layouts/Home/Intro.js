          ...
          <Fragment>
            ...
            <header className={styles.text}>
              <h1 className={styles.name} data-visible={visible} id={titleId}>
                <DecoderText text="CoinBeast 2.0" delay={300} />
              </h1>
              <h6 className={styles.namez} data-visible={visible} id={titleId}>
                <DecoderText text="A Listing/Trending Services Platform" delay={300} />
              </h6>
